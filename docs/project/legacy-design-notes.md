...
Omit payment and refund timestamps and transaction/reference numbers from both HTML and
plain-text emails, including school notifications. Keep those fields in the underlying payment
record. Refund emails retain the refund amount, original-payment-method destination, and bank
