    ...
    <section className="faq-section section-space" id={id}>
      <div className="page-shell faq-layout">
        ...
        <div className="faq-list">
          <details><summary>What ages do you teach?</summary><p>We welcome young dancers ages 3 and up. Please contact us about older beginners or age-specific availability.</p></details>
          ...
          <details><summary>Can my child enroll only in a competition solo or duet?</summary><p>No. Students participating in the competition program are required to attend Level Classes and complete a minimum of 2 hours of training each week.</p></details>
